...
cp -r bodyct-luna23-ismi-trainer/train_classification_malignancy.py /scratch-shared/ssommers/

# Set project directory to scratch space
project_dir=/scratch-shared/ssommers/

# Execute program
python /scratch-shared/ssommers/train_classification_malignancy.py $project_dir
