...
cp -r data/luna23-ismi-train-set.csv /scratch-shared/ssommers/data/
cp -r multitaskNetwork.py /scratch-shared/ssommers/
cp -r dataloaderDuplicate.py /scratch-shared/ssommers/
cp -r bodyct-luna23-ismi-trainer/inference.py /scratch-shared/ssommers/
cp -r trainMultitask.py /scratch-shared/ssommers/

# Set project directory to scratch space
project_dir=/scratch-shared/ssommers/

# Execute program
python /scratch-shared/ssommers/trainMultitask.py $project_dir
